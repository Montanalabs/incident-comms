...
- `incident-comms_safe.eide` — the correct design.
- `incident-comms_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
